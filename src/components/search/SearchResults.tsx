...
const SearchResults = ({ searchParams }: SearchResultsProps) => {
  ...
  const [totalListings, setTotalListings] = useState(LISTINGS_DATA.length);
  ...
  const guestsStr = typeof searchParams.guests === 'string' ? searchParams.guests : undefined;
  ...
  }, [location, checkInStr, checkOutStr, guestsStr]);
